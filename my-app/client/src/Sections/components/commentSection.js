  ...
  return (
    <>
      {user.comments.map(function (item, i) {
        //getUser(item.userId)
        axios
          .get("https://backend-z03p.onrender.com/user/" + item.userId, {
            headers: {
          ...
          .then(function (response) {
            ...
            listedUser = response.data.userSelect;
        ...
        return (
          <Paper style={{ padding: "5px 5px", marginTop: 10, marginLeft: 46 }}>
            <Grid container wrap="nowrap" spacing={2}>
              <Grid item>
                <Avatar
                  alt="Remy Sharp"
                  src={
                    "https://backend-z03p.onrender.com/assets/"+listedUser.picture}
                />
              </Grid>
